...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:root@localhost/plot_details_db'
...
def get_dropdown_values():
    ...
    # # Optional: If you want to print the data as a JSON string for readability
    # import json
